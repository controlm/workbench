...
2. Run:
```
docker pull containers.bmc.com/bmc/workbench:9.21.315-GA
```
...
```
docker run -dt --cpus=4 -m 8g -p 8443:8443 --hostname=workbench containers.bmc.com/bmc/workbench:9.21.315-GA
```
